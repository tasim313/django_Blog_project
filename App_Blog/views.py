...
class CreateBlog(LoginRequiredMixin, CreateView):
    ...
    def form_valid(self, form):
        ...
        blog_obj.slug = title.replace(" ", "-") + "-" + str(uuid.uuid1())
        blog_obj.save()
...
def blog_details(request, blog_title):
    blog = Blog.objects.get(blog_title=blog_title)
    ...
    if request.method == 'POST':
        ...
        if comment_form.is_valid():
            ...
            comment.blog = blog
            comment.save()
            return HttpResponseRedirect(reverse('App_blog:blog_details', kwargs={'blog_title': blog_title}))
...
def liked(request, pk):
    ...
    if not already_liked:
        ...
        liked_post.save()
    return HttpResponseRedirect(reverse('App_blog:blog_details', kwargs={'blog_title': blog.blog_title}))
...
class UpdateBlogs(LoginRequiredMixin, UpdateView):
    ...
    def get_success_url(self, **kwargs):
        return reverse_lazy('App_blog:blog_details', kwargs={'blog_title': self.object.blog_title})
